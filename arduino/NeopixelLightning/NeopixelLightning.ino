...
uint32_t fade(uint32_t color, double fade) {
    uint8_t r = (color & 0xff0000) >> 16;
    uint8_t g = (color & 0xff00) >> 8;
    uint8_t b = (color & 0xff);
    return strip.Color(constrain(r * fade, 0, 255),
                       constrain(g * fade, 0, 255),
                       constrain(b * fade, 0, 255));
}
...
void loop() {
  ...
  uint8_t width = random(1, 7);
  bounce(color, width, 10);
  }
}
